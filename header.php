...
<head>
    ...
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo get_bloginfo('template_url'); ?>/apple-touch-icon.png">
    ...
    <link rel="manifest" href="<?php echo get_bloginfo('template_url'); ?>/site.webmanifest">
